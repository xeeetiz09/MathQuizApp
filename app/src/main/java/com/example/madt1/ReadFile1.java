...
public class ReadFile1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_read_file1);
...
//    FUNCTION TO READ THE FILE
    private String readFile(Context cnt) {
        ...
        try {
            InputStream inputStream = cnt.openFileInput(getIntent().getStringExtra("username") + "_RSP.txt");
